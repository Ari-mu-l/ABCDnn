...
#parser.add_argument("--productionMode", action="store_true")

fitType = parser.parse_args().fitType
case = parser.parse_args().case

#if args.productionMode:
#    print("Not in production mode. Optimzation run...\n")
...
if fitType=="skewNorm_quadratic":
    ...
    nparams = 8
    fit = TF1("fitFunc", fitFunc, 400, 2500, nparams)
    fit.SetParameters(5, 400, 500, 50, 0.00001, 0.000001, 0.0000001)
elif fitType=="landau":
